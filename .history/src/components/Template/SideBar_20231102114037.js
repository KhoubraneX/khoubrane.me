...
const SideBar = () => (
  <section id="sidebar">
    ...
    <section className="blurb">
      <h2>About</h2>
      <p>I'm Marouane Khoubrane, a web developer with a passion for crafting visually captivating and user-friendly websites. With a focus on optimizing performance and effective client communication, I continue to expand my skillset and demonstrate adaptability and problem-solving abilities.
